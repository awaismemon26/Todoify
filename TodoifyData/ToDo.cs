    ...
    public class ToDo
    {
        ...
        public List<ToDo> GetAll()
        {
            List<ToDo> list = new List<ToDo>()
            {
                ...
                new ToDo { ID = 9, TaskName = "Clean harddrives", CreationDate = new DateTime(2021, 04, 03), DueDate = new DateTime(2021, 04, 05), CompletionStatus = false },
                new ToDo { ID = 10, TaskName = "Learn Distributed Systems", CreationDate = new DateTime(2021, 01, 15), DueDate = new DateTime(2021, 04, 11), CompletionStatus = false },
            };
